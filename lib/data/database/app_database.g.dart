    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `products` (`id` INTEGER, `name` TEXT NOT NULL, PRIMARY KEY (`id`))');
        await database.execute(
...
class _$ProductDao extends ProductDao {
  ...
  Future<List<ProductModel>> getAllProducts() async {
    return _queryAdapter.queryList('SELECT * FROM products ORDER BY id DESC',
        mapper: (Map<String, Object?> row) =>
            ProductModel(id: row['id'] as int?, name: row['name'] as String));
  }
